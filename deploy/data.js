...
/* ============================ OpenAI ============================ */
{
  ...
  caps: ["vision","file","tools","json","reasoning"],
  vendorTag: "OpenAI官方",
...
},
{
  ...
  tags: ["text","multimodal","code","reasoning"],
  caps: ["vision","file","tools","reasoning"],
  vendorTag: "Anthropic官方",
...
},
{
  ...
  inputPm: 21.3, outputPm: 106.5, cnyOnly: true, context: "100W",
  tags: ["text","multimodal","code","reasoning","longctx"],
  caps: ["vision","video","tools","json","reasoning"],
  vendorTag: "阿里云百炼/官方",
...
},
{
  ...
  vendor: "Zhipu", vendorZh: "智谱", type: "通用均衡", billing: "per_token",
  inputPm: 5.964, outputPm: 18.744, cnyOnly: true, context: "200K",
