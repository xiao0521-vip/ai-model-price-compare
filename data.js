...
/* ======================= DeepSeek（深度求索） ====================== */
{
  ...
  inputPm: 0.34392399999999995, outputPm: 0.6878479999999999, cnyOnly: true, context: "1.0M",
  tags: ["text","code","reasoning","longctx"],
  vendorTag: "官方",
...
},
{
  ...
  inputPm: 1.9098999999999997, outputPm: 2.84, cnyOnly: true, context: "164K",
  tags: ["text","code","reasoning"],
  vendorTag: "硅基流动",
...
},
{
  ...
  inputPm: 14.199999999999998, outputPm: 42.6, cnyOnly: true, context: "1.0M",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "阿里云百炼",
...
/* ========================== 月之暗面·Kimi ========================= */
{
  ...
  inputPm: 6.745, outputPm: 28.399999999999995, cnyOnly: true, context: "100W",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "Kimi官方",
...
},
{
  ...
  inputPm: 5.0140199999999995, outputPm: 22.791, cnyOnly: true, context: "262K",
...
},
{
  ...
  inputPm: 13.844999999999999, outputPm: 77.532, cnyOnly: true, context: "100W",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "阿里云百炼/官方",
...
/* ============================ 智谱·GLM =========================== */
{
  ...
  inputPm: 0.6389999999999999, outputPm: 2.13, cnyOnly: true, context: "200K",
  tags: ["text","code","reasoning","agent"],
  vendorTag: "七牛云AI",
...
},
{
  ...
  inputPm: 3.9362399999999997, outputPm: 12.37104, cnyOnly: true, context: "200K",
  tags: ["text","code","reasoning","agent"],
  vendorTag: "七牛云AI",
...
},
{
  ...
  vendor: "Zhipu", vendorZh: "智谱", type: "通用均衡", billing: "per_token",
  inputPm: 6.460999999999999, outputPm: 20.305999999999997, cnyOnly: true, context: "200K",
...
/* =========================== 腾讯·混元 ============================ */
{
  ...
  inputPm: 1.2779999999999998, outputPm: 4.26, cnyOnly: true, context: "262K",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "硅基流动",
