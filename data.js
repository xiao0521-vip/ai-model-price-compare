 ...
 * 更新时间：2026-09-18  |  收录 69 款模型 + 24 组订阅/套餐
 * ---------------------------------------------------------------------
 * 换算口径：
...
},
{
  ...
  inputPm: 4.19, outputPm: 5.61, cnyOnly: false, context: "128K",
...
/* ======================= DeepSeek（深度求索） ====================== */
{
  ...
  inputPm: 1.0, outputPm: 2.0, cnyOnly: true, context: "1.0M",
  tags: ["text","code","reasoning","longctx"],
  vendorTag: "官方",
...
},
{
  ...
  inputPm: 4.0, outputPm: 6.0, cnyOnly: true, context: "164K",
  tags: ["text","code","reasoning"],
  vendorTag: "硅基流动",
...
},
{
  ...
  inputPm: 3.0, outputPm: 6.0, cnyOnly: true, context: "1.0M",
  tags: ["text","code","reasoning","longctx"],
  vendorTag: "官方",
...
/* ========================== 阿里·通义千问 ========================= */
{
  ...
  inputPm: 0.8, outputPm: 2.7, cnyOnly: true, context: "1.0M",
  tags: ["text","code","reasoning","longctx"],
  vendorTag: "阿里云百炼",
...
},
{
  ...
  inputPm: 12.0, outputPm: 36.0, cnyOnly: true, context: "1.0M",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "阿里云百炼",
...
/* ========================== 月之暗面·Kimi ========================= */
{
  ...
  inputPm: 4.0, outputPm: 21.0, cnyOnly: true, context: "100W",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "Kimi官方",
...
},
{
  ...
  inputPm: 6.1, outputPm: 26.98, cnyOnly: true, context: "262K",
...
},
{
  ...
  inputPm: 20.0, outputPm: 100.0, cnyOnly: true, context: "100W",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "阿里云百炼/官方",
...
/* ============================ 智谱·GLM =========================== */
{
  ...
  inputPm: 0.4, outputPm: 1.4, cnyOnly: true, context: "200K",
  tags: ["text","code","reasoning","agent"],
  vendorTag: "七牛云AI",
...
},
{
  ...
  inputPm: 4.0, outputPm: 18.0, cnyOnly: true, context: "200K",
  tags: ["text","code","reasoning","agent"],
  vendorTag: "七牛云AI",
...
},
{
  ...
  vendor: "Zhipu", vendorZh: "智谱", type: "通用均衡", billing: "per_token",
  inputPm: 8.0, outputPm: 28.0, cnyOnly: true, context: "200K",
...
/* ============================ MiniMax ============================ */
{
  ...
  inputPm: 2.1, outputPm: 8.4, cnyOnly: true, context: "200K",
  tags: ["text","code","reasoning","longctx"],
  vendorTag: "硅基流动",
...
/* ========================= 字节·豆包·火山方舟 ====================== */
{
  ...
  inputPm: 0.2, outputPm: 2.0, cnyOnly: true, context: "128K",
  tags: ["text","code","reasoning"],
  vendorTag: "火山方舟",
...
/* =========================== 腾讯·混元 ============================ */
{
  ...
  inputPm: 0.94, outputPm: 3.75, cnyOnly: true, context: "262K",
  tags: ["text","multimodal","code","reasoning","longctx"],
  vendorTag: "硅基流动",
